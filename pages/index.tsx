    ...
    <div className="mt-5 items-center text-center sm:mt-0 ">
      ...
      <div>
        <span className="text-xl font-extrabold ">
          My name is Matthew, that's my dog Zuko, and this is my website. I hope
          you enjoy and interact (Look for{" "}
          <ShowCodeButton codeToShow="index" className="inline" /> to view some
          components source code, to see everything visit my{" "}
          <a
        ...
        <br />
        <br />I am a full stack software engineer with a passion for building
        scalable and efficient applications, please see{" "}
        <Link
          className="underline hover:text-dp-back hover:dark:text-ls-fore"
          href="/skills"
        >
        ...
        for more specific experience. With a strong foundation in software
        engineering and a desire to constantly learn and improve, I have set my
        phasers to 'love me'
        <span className="italic"> as well as </span>
        blockchain development / technologies. Feel free to connect and play
        around in the{" "}
        <Link
          className="underline hover:text-dp-back hover:dark:text-ls-fore"
          href="/dapp"
        ...
        page. I am also interested in Smart Contract auditing, with that being
        said, I am currently offering free Smart Contract audits. Please visit{" "}
        <Link
          className="underline hover:text-dp-back hover:dark:text-ls-fore"
          href="/audits"
        >
